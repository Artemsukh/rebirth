...
- **언어:** 한국어, English, 日本語, Español. 페이지 맨 위 막대에서 고르면 강조 표시가 그 언어로 미끄러져 가고, 새로 고침 없이 모든 글과 숫자 표기(1억 3,250만 / 132.5 million / 1億3,250万 / 132,5 millones), 날짜, 나라 이름이 바뀝니다.
...
- **처음 고르는 언어:** 주소의 `?lang=ko|en|ja|es`, 지난번에 고른 언어(localStorage `rebirth-simulator-lang`), 브라우저 언어 순서로 찾고, 넷 중 어느 것도 아니면 영어로 엽니다. 막대에서 바꾸면 그 선택을 저장하고, 주소에 `?lang=`이 있으면 그 값도 바꿉니다.
